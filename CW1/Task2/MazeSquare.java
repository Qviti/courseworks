...
public class MazeSquare extends GameSquare 
{
    ...
    public void leftClicked() 
    {
        ...
        setHighlight(true);                          // Highlight this square
    }
    ...
    private void printPath(List<MazeSquare> path) 
    {
        ...
        for (MazeSquare square : path) 
        {
            ...
            square.setHighlight(true);             // Highlight each square in the path.
        }
        ...
        System.out.println("Path length: " + path.size());     // Print the length of the path.
    ...
    public void reset(int placeHolderInteger) 
    {
        ...
        this.setHighlight(false);                   // Unhighlight this square.
